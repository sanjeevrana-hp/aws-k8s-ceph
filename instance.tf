...
wget https://raw.githubusercontent.com/sanjeevrana-hp/aws-k8s-ceph/main/install_master.sh
...
cd /var/tmp/
apt-get install wget
wget https://raw.githubusercontent.com/sanjeevrana-hp/aws-k8s-ceph/main/install_worker.sh
